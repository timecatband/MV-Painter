...
class BakeConfig:
    ...
    def __init__(self,offset,candidate_view_weights):
        ...
        # offset = -90
        self.candidate_camera_azims = [0 + offset, 90 + offset, 180 + offset, 270+offset,  offset, offset]
...
class BakePipeline:
    ...
    def __init__(self,offset = -90,candidate_view_weights = [1, 0.1, 0.1, 0.1, 0.05, 0.05]):
        # self.config = config
        self.models = {}
    ...
    def call_bake(self, mesh, image_paths):
        ...
        for path in image_paths:
            ...
            image_prompt = scale_image(image_prompt,1.1)
...
pipeline = BakePipeline(offset=0)
...
if __name__ == "__main__":
    ...
    for casename in os.listdir(dir_path):
        ...
        img_paths = [os.path.join(work_dir,f'result_{i}{suffix}.png') for i in [1,2,3,4,5,6]]
