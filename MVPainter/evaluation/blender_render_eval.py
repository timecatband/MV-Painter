...
parser.add_argument("--output_dir", type=str, default="/home/sunzhaoxu/code/InstantMesh/blender_smq/") #/data/54T/wyw/data/objverse_obj_render_pbr/
parser.add_argument(
...
parser.add_argument("--azimuth_offset", type=int, default=0)
...
#     bproc.init()
    # add_hdri_lighting("/home/sunzhaoxu/code/InstantMesh/blender_scripts/overcast_soil_puresky_4k.exr")
    add_hdri_lighting('/mnt/xlab-nas-2/shaomingqi.smq/projects/aigc3d_dev/aigc3d/data_process/evaulate_mvpainter/overcast_soil_puresky_2k.exr')
    ...
    azimuth_list = [0,90,180,270,  45, 135, 225, 315, -45, 45, 135, 225]
    elevation_list = [0,0,0,0, 30,30,30,30, -30,-30,-30,-30]
    for i in range(len(azimuth_list)):
        azimuth_list[i] += args.azimuth_offset
