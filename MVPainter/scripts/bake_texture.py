...
from src.utils.differentiable_renderer.mesh_render import MeshRender

from src.utils.uv_warp_utils import mesh_uv_wrap
...
class MVPainterBakePipeline:


    def __init__(self,offset = -90,candidate_view_weights = [1, 0.1, 0.1, 0.1, 0.05, 0]):
        # self.config = config
        self.models = {}
